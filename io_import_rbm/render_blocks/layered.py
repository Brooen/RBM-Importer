...
def process_block(filepath, file, imported_objects):
    ...
    if material is None:
        ...
        node_group = bpy.data.node_groups.get("Layered")
        if not node_group:
            print("Node group 'Layered' not found.")
        else:
        ...
        TEXTURE_SETTINGS = {
            "uv1": [1, 2, 3, 4, 5, 6, 7, 8], #base, layered
            "uv2": [9], #mask   
        }
