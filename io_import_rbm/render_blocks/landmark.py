...
#This RenderBlock needs: UV extent/transforms??, Flags??
...
def process_block(filepath, file, imported_objects):
    ...
    uv1_coords = scale_uvs(uv1_coords)
    ...
    if material is None:
        ...
        node_group = bpy.data.node_groups.get("Landmark")
        if not node_group:
            print("Node group 'Landmark' not found.")
        else:
        ...
        input_index = 0  # Start at input index 0 to skip the first 0 inputs (this number is booleans)
